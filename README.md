...
3. **Weather API Agent**: Geocodes location → fetches weather data
    - Uses **Open-Meteo**:
...
5. **Summarizer Agent** (LLM): Converts structured data → natural language
6. **Final Answer Agent**: Returns formatted response
